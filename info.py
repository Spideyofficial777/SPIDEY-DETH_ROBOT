...
#---------------------------------------------------------------
#---------------------------------------------------------------
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '6893463477 7965267063').split()]
...
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002466764492').split()]
#---------------------------------------------------------------
#---------------------------------------------------------------
...
auth_channel = environ.get('AUTH_CHANNEL', '-1002252585703')
...
SHORTENER_API2 = environ.get("SHORTENER_API2", "09c3f9bc3a8b121b1e6b82a954e59da523dd188e")
...
if 'DYNO' in environ:
    ...
    ON_HEROKU = False
URL = environ.get("FQDN", "https://glorious-martynne-hackerxofficial-a41df8e9.koyeb.app/")
